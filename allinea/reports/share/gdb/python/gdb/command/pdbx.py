...
#
# Modified by Allinea Software.
# 
# Copyright (C) Allinea Software Ltd. 2017
...
class PdbxCommunicator(gdb.Breakpoint):
    ...
    def stop(self):
        ...
        try:
            ...
            print "internal error: %s" % error
            traceback.print_exc()
            raise gdb.GdbError("Warning: pdbx got out of sync. May miss races.")
        return False

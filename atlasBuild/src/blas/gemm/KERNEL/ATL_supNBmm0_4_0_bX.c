#define ATL_USERMM ATL_supNBmm0_4_0_bX
#define ATL_USERMM_b1 ATL_supNBmm0_4_0_b1
#define ATL_USERMM_bn1 ATL_supNBmm0_4_0_bn1
#define ATL_USERMM_b0 ATL_supNBmm0_4_0_b0
#define ATL_USERMM_bX ATL_supNBmm0_4_0_bX
#define BETAX
#define SREAL
 ...
 */
{
   ...
   #endif
   const size_t incAm = (lda<<2), incBn = ldb*4;

...
#endif
#endif
static void ATL_cJIK2x0x80TN2x1x24_a1_b1
 ...
 */
   ...
   #undef Kb
#endif
static void ATL_cJIK80x0x80TN3x1x24_a1_b1
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 ...
 */
   ...
   while(pB0 != stN);
   ATL_cJIK2x0x80TN2x1x24_a1_b1(2, N, 80, alpha, ca + 6240, lda, cb, ldb, beta, cc + 156, ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_cJIK2x0x80TN2x2x24_a1_b1
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=2, NB=0, KB=80, 
 ...
 */
   ...
   if (k=N-Nb)
      ATL_cJIK80x0x80TN3x1x24_a1_b1(80, k, 80, alpha, ca, lda, cb + (((Nb) << 6)+((Nb) << 4)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
   if (Nb)

      ATL_cJIK2x0x80TN2x2x24_a1_b1(2, Nb, 80, alpha, ca + 6240, lda, cb, ldb, beta, cc + 156, ldc);
}
#ifdef incAm
   #undef incAm
#endif

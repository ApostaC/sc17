...
static void ATL_cJIK0x0x52TN1x1x4_aX_bX
 ...
 */
{
   ...
   #undef Kb
#endif
static void ATL_cJIK0x0x52TN3x1x4_aX_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=52, 
 ...
 */
{
   ...
   if (k=M-Mb)
      ATL_cJIK0x0x52TN1x1x4_aX_bX(k, N, 52, alpha, ca + (((Mb*lda) << 1)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
static void ATL_cJIK0x0x52TN1x2x4_aX_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=52, 
 ...
 */
{
   ...
   if (k=N-Nb)
      ATL_cJIK0x0x52TN1x1x4_aX_bX(M, k, 52, alpha, ca, lda, cb + (((Nb*ldb) << 1)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
 ...
 */
{
   ...
   if (k=N-Nb)
      ATL_cJIK0x0x52TN3x1x4_aX_bX(M, k, 52, alpha, ca, lda, cb + (((Nb*ldb) << 1)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
   if (Nb && (k=M-Mb))
      ATL_cJIK0x0x52TN1x2x4_aX_bX(k, Nb, 52, alpha, ca + (((Mb*lda) << 1)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif

...
static void ATL_ZupNBmm0_5_0_b0
   (const int M, const int N, const int K, const double alpha,
    const double *A, const int lda, const double *B, const int ldb,
    const double beta, double *C, const int ldc)
{
   const double *rA = A + lda*M, *rB = B + ldb*N;
   ATL_zupNBmm0_5_0_b0(M, N, K, alpha, A, lda, B, ldb, ATL_rzero, C, ldc); 
   ATL_zupNBmm0_5_0_b0(M, N, K, alpha, A, lda, rB, ldb, beta, C+1, ldc); 
...
static void ATL_ZupNBmm0_3_0_b0
   (const int M, const int N, const int K, const double alpha,
    const double *A, const int lda, const double *B, const int ldb,
    const double beta, double *C, const int ldc)
{
   const double *rA = A + lda*M, *rB = B + ldb*N;
   ATL_zupNBmm0_3_0_b0(M, N, K, alpha, A, lda, B, ldb, ATL_rzero, C, ldc); 
   ATL_zupNBmm0_3_0_b0(M, N, K, alpha, A, lda, rB, ldb, beta, C+1, ldc); 
...
static void ATL_ZupNBmm0_2_0_b0
   (const int M, const int N, const int K, const double alpha,
    const double *A, const int lda, const double *B, const int ldb,
    const double beta, double *C, const int ldc)
{
   const double *rA = A + lda*M, *rB = B + ldb*N;
   ATL_zupNBmm0_2_0_b0(M, N, K, alpha, A, lda, B, ldb, ATL_rzero, C, ldc); 
   ATL_zupNBmm0_2_0_b0(M, N, K, alpha, A, lda, rB, ldb, beta, C+1, ldc); 
...
static void ATL_ZupNBmm0_1_0_b0
   (const int M, const int N, const int K, const double alpha,
    const double *A, const int lda, const double *B, const int ldb,
    const double beta, double *C, const int ldc)
{
   const double *rA = A + lda*M, *rB = B + ldb*N;
   ATL_zupNBmm0_1_0_b0(M, N, K, alpha, A, lda, B, ldb, ATL_rzero, C, ldc); 
   ATL_zupNBmm0_1_0_b0(M, N, K, alpha, A, lda, rB, ldb, beta, C+1, ldc); 

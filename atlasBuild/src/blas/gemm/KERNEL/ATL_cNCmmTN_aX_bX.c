...
static void ATL_cJIK1x52x52TN1x2x52_aX_bX
...
/*
 * matmul with TA=T, TB=N, MB=1, NB=52, KB=52, 
 ...
 */
{
   ...
   while(pB0 != stN);
   ATL_cJIK1x52x52TN1x2x52_aX_bX(1, 52, 52, alpha, ca + (102*(lda)), lda, cb, ldb, beta, cc + 102, ldc);
}
#ifdef incAm
   #undef incAm
#endif

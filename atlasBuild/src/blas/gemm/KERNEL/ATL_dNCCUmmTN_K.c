...
static void ATL_dJIK0x0x72TN1x1x24_aX_bX
 ...
 */
{
   ...
   #undef Kb
#endif
static void ATL_dJIK0x0x72TN3x1x24_aX_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=72, 
 * lda=0, ldb=0, ldc=0, mu=3, nu=1, ku=24, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.3)
 */
{
   const int Mb = (M/3)*3;
   ...
   const double BetaAlpha = beta / alpha;
   #define incAk 24
   const int incAm = ((((lda) << 1)+lda) - 72), incAn = -(Mb*lda);
   #define incBk 24
   const int incBm = -72, incBn = (ldb);
   #define incCm 3
   const int incCn = (ldc) - (Mb);
   ...
   if (k=M-Mb)
      ATL_dJIK0x0x72TN1x1x24_aX_bX(k, N, 72, alpha, ca + (Mb*lda), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
static void ATL_dJIK0x0x72TN1x4x24_aX_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=72, 
 * lda=0, ldb=0, ldc=0, mu=1, nu=4, ku=24, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.3)
 */
{
   #define Mb M
   ...
   if (k=N-Nb)
      ATL_dJIK0x0x72TN1x1x24_aX_bX(M, k, 72, alpha, ca, lda, cb + (Nb*ldb), ldb, beta, cc + (Nb*ldc), ldc);
}
#ifdef incAm
   #undef incAm
#endif
   ...
   #undef Kb
#endif
void ATL_dJIK0x0x72TN0x0x0_aX_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=72, 
 ...
 */
{
   ...
   if (k=N-Nb)
      ATL_dJIK0x0x72TN3x1x24_aX_bX(M, k, 72, alpha, ca, lda, cb + (Nb*ldb), ldb, beta, cc + (Nb*ldc), ldc);
   if (Nb && (k=M-Mb))
      ATL_dJIK0x0x72TN1x4x24_aX_bX(k, Nb, 72, alpha, ca + (Mb*lda), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif

...
static void ATL_zJIK2x56x0TN2x4x18_a1_b1
...
/*
 * matmul with TA=T, TB=N, MB=2, NB=56, KB=0, 
 * lda=0, ldb=0, ldc=0, mu=2, nu=4, ku=18, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.3)
 */
{
   const int Kb = (K/18)*18;
   ...
   do /* N-loop */
   {
      ...
      rC0_3 = *pC3;
      rC1_3 = pC3[2];
      for (k=0; k < Kb; k += 18) /* easy loop to unroll */
      {
         rA0 = *pA0;
         rB0 = *pB0;
         rA1 = *pA1;
   ...
   #undef Kb
#endif
void ATL_zJIK56x56x0TN0x0x0_a1_b1
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=56, NB=56, KB=0, 
 * lda=0, ldb=0, ldc=0, mu=3, nu=4, ku=18, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.3)
 */
{
   const int Kb = (K/18)*18;
   ...
   while(pB0 != stN);
   ATL_zJIK2x56x0TN2x4x18_a1_b1(2, 56, K, alpha, ca + (54*(lda)), lda, cb, ldb, beta, cc + 108, ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
static void ATL_zJIK2x56x0TN2x4x18_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=2, NB=56, KB=0, 
 * lda=0, ldb=0, ldc=0, mu=2, nu=4, ku=18, pf=1
 ...
 */
{
   ...
   #undef Kb
#endif
void ATL_zJIK56x56x0TN0x0x0_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=56, NB=56, KB=0, 
 * lda=0, ldb=0, ldc=0, mu=3, nu=4, ku=18, pf=1
 ...
 */
{
   ...
   while(pB0 != stN);
   ATL_zJIK2x56x0TN2x4x18_a1_bX(2, 56, K, alpha, ca + (54*(lda)), lda, cb, ldb, beta, cc + 108, ldc);
}
#ifdef incAm
   #undef incAm
#endif
